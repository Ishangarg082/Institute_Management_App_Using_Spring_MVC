...
public class MarksDao {
	...
	@Transactional
	public void delete(String rollnumber, int marksid, String marks, String courseid) {
		...
		mark.setMarksid(marksid);
		mark.setRollnumber(rollnumber);
		List<Marks> mark1 =getmarksByRollNumber(rollnumber);
		List<Marks> mark2 = getmarksByCourseId(courseid);
		if (mark1.contains(mark) || mark2.contains(mark)) {
